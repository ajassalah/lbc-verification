...
export default function Create({ auth }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('centers.store'));
    };

    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl leading-tight">Create Center</h2>}
        >
                    ...
                    >
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="flex justify-end gap-3">
                                ...
                                <PrimaryButton disabled={processing}>Create Center</PrimaryButton>
                            </div>
                        </form>
                    </motion.div>
                </div>
